...
class SlideExpandableListView extends ListView {
	private MySlideExpandableListAdapter adapter;
	...
	public void setAdapter(ListAdapter adapter) {
		this.adapter = new MySlideExpandableListAdapter(adapter);
	...
	public void enableExpandOnItemClick() {
		this.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
				MySlideExpandableListAdapter adapter = (MySlideExpandableListAdapter)getAdapter();
